...
\Manip A partir de cet exemple, réaliser un script qui permette de lancer l'acquisition de données pour des angles allant de $-40\deg{}$ à $+60\deg{}$ par pas de $10\deg{}$ et la récupération des données acquises dans une liste en Python.
