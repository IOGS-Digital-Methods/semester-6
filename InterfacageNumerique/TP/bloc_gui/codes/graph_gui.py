...
*graph_gui* file contains an example of graphics displaying in a widget.
...
.. moduleauthor:: Lucas CARON <lucas.caron@institutoptique.fr>
.. creation:: 20/nov/2024
"""
...
class MainWidget(QWidget):
    ...
    def action_signal(self, event):
        if event == 'loaded':
            ...
            exporter.export('MyGraph.png')
            print("Plot saved as 'MyGraph.png'")
