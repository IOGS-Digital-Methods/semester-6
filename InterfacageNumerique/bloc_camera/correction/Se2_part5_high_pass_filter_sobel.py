# -*- coding: utf-8 -*-
"""*Se2_part5_high_pass_filter_sobel.py* file.

This file contains a script to apply a high-pass (sobel operator) filter on an image.
...
if __name__ == "__main__":
    ...
    ax[0,1].set_title('Sobel filtered Image')
