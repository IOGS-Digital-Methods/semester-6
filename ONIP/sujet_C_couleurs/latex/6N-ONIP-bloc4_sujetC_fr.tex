...
\begin{figure}[H]
	\centering\includegraphics[width=0.5\linewidth]{../../_latex_assets/logo_iogs.pdf}
\end{figure}
...
\begin{minipage}[t]{.60\linewidth} % Mini page taking up 66% of the actual page
	...
	\begin{center}
		\textit{"And I'll see your true colors"}, Cyndi Lauper
	\end{center}

	% \hypertarget provides a label to reference using \hyperlink{label}{link text}
