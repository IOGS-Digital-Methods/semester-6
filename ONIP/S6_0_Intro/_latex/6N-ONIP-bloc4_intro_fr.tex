...
\begin{itemize}
    ...
    \item ajoutez une méthode intersection\_rect qui prendra un objet \textbf{Rectangle} en argument et retournera les points d'intersection entre un cercle et un rectangle.
    \item redéfinissez la classe \textbf{\textit{\_\_str\_\_}}
\end{itemize}
\end{mdframed}
