...
L'ensemble des documents du module ONIP-2 se trouve sur le site du LEnsE : \hyperlink{http://lense.institutoptique.fr/ONIP/}{http://lense.institutoptique.fr/ONIP/} . Les exemples pour cette première séance se trouvent dans la rubrique \textbf{BLOC 4}. \textbf{Attention}, les classes crées pour ces exercices ne seront pas réutilisées pour les projets. 
...
\begin{itemize}
    ...
    \item définissez une méthode intersection qui prend un objet \textbf{Rectangle} en argument, calcul les coordonnées du rectangle correspondant à l'intersection et retourne l'objet \textbf{Rectangle} correspondant.
    \item définir une méthode agrandir qui applique un facteur d'échelle au rectangle
    \item redéfinissez la classe \textbf{\textit{\_\_str\_\_}}
...
\begin{itemize}
    ...
    \item ajoutez une méthode intersection\_rect qui prendra un objet \textbf{Rectangle} en argument et retournera les deux points d'intersection entre un cercle et un rectangle.
    \item redéfinissez la classe \textbf{\textit{\_\_str\_\_}}
\end{itemize}
\end{mdframed}
