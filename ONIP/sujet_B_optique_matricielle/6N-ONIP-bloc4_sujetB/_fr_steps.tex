...
\textit{Ce projet s'inscrit dans la continuité du cours d'optique instrumentale, vous pouvez tester vos simulations sur des travaux réalisés dans cette matière.}

\section{Introduction}

Le contexte de ce projet est l'optique dans les conditions de Gauß pour des systèmes centrés. En effet, on utilisera le formalisme matriciel (aussi appelé \og matrice $ABCD$ \fg), celui-ci est très commode pour la programmation informatique. Ce formalisme est équivalent à celui étudié en cours.
...
\begin{wrapfigure}{r}{0.38\textwidth}
	\centering
	\includegraphics[width=0.3\textwidth]{6N-ONIP-bloc4_sujetB/images/rayon.pdf}
	\caption{Représentation d'un rayon.}
	\label{fig:6N-ONIP-bloc4_sujetB_fig1}
\end{wrapfigure}
...
Pour effectuer des transformations sur les rayons, on utilise des matrices de transfert. La figure \ref{fig:6N-ONIP-bloc4_sujetB_fig1} illustre la propagation d'un rayon à travers un élément optique.

\textit{NB : Il existe différentes conventions, par exemple sans les indices $n$ pour la deuxième composante, cela est moins intéressant. En effet, les déterminants des matrices de transfert ne sont plus égaux à 1, les matrices des dioptres plans ne sont plus égaux à la matrice identité...}
...
Le système optique est composé d'un objectif de distance focale $f' = 40$\,mm et d'un oculaire de distance focale $f' = 12.5$\,mm. Un schéma réalisé via Python est donné en figure \ref{fig:6N-ONIP-bloc4_sujetB_fig2}.
...
\begin{figure}[h]
	...
	\label{fig:6N-ONIP-bloc4_sujetB_fig2}
\end{figure}
...
On considère ici le \href{https://fr.wikipedia.org/wiki/Télescope_de_type_Cassegrain}{télescope de Cassegrain} issu du TD N$^o$8 d'optique instrumentale, représenté en figure \ref{fig:6N-ONIP-bloc4_sujetB_fig3}. Le système optique est composé d'un miroir primaire concave de rayon de courbure $R_1 = 250$\,mm et d'un miroir secondaire convexe de rayon de courbure $R_2 = 100$\,mm. Les autres grandeurs du système sont présentent dans le sujet de TD sur le site du \href{https://lense.institutoptique.fr/optique-instrumentale-s5/}{LEnsE}.
...
\begin{figure}[h]
	...
	\label{fig:6N-ONIP-bloc4_sujetB_fig3}
\end{figure}
...
Sur la figure \ref{fig:6N-ONIP-bloc4_sujetB_fig3}, nous avons pu déterminer la position de l'image ainsi que la position et la taille de la pupille de sortie.
...
\begin{wrapfigure}{r}{0.45\textwidth}
	\centering
	\includegraphics[width=0.35\textwidth]{6N-ONIP-bloc4_sujetB/images/schema_grandeur.pdf}
\end{wrapfigure}
