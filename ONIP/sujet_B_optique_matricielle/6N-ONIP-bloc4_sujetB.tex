...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	6N-ONIP-Block4	/ Project D
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Created by:
%	Julien VILLEMEJANE - 22/nov/2023
% Modified by: Corentin Nannini (2025)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\dirName{6N-ONIP-bloc4_sujetB}
...
\hypertarget{stepbystep}{\heading{Sujet D - Simulation en optique matricielle}{6pt}} % \hypertarget provides a label to reference using \hyperlink{label}{link text}
