...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	6N-ONIP-Block4	/ Project C
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Created by:
%	Julien VILLEMEJANE - 22/nov/2023
% Modified by: Corentin Nannini (2024)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\dirName{6N-ONIP-bloc4_sujetC}
...
\hypertarget{stepbystep}{\heading{Sujet C - Calibration d'image numérique}{6pt}} % \hypertarget provides a label to reference using \hyperlink{label}{link text}
