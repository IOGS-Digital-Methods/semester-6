...
\input{../../../Latex/_latex_assets/5N_ONIP_structure.tex} % Include the document which specifies all packages and structural customizations for this template

\def\dirName{6N-ONIP-bloc4_intro_fisa}
...
\begin{figure}[H]
\centering\includegraphics[width=0.5\linewidth]{../../../Latex/_latex_assets/logo_iogs.png}
\end{figure}
...
\begin{mdframed}[style=intextbox,frametitle={Déroulement du bloc}] % Sidebar box

Ce module se déroule sur \textbf{4 séances} :

\begin{description}
	\item[Séance 1] Découverte de la programmation objet 
	\item[Séances 2 et 3] Réalisation du mini-projet en binôme
	\item[Séance 4] Evaluation du mini-projet en binôme
\end{description}
...
\hypertarget{stepbystep}{\heading{Exemples à analyser et exercices}{6pt}} % \hypertarget provides a label to reference using \hyperlink{label}{link text}
...
Même exercice avec un cercle défini par son centre et un point du rayon.
